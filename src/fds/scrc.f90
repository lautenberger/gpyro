...
CHARACTER(255), PARAMETER :: scrchid='$Id: scrc.f90 21932 2015-03-10 20:30:50Z mcgratta $'
CHARACTER(255), PARAMETER :: scrcrev='$Revision: 21932 $'
CHARACTER(255), PARAMETER :: scrcdate='$Date: 2015-03-10 13:30:50 -0700 (Tue, 10 Mar 2015) $'
...
DO NM = 1, NMESHES
   ...
   DO INBR = 1, S%NUM_NEIGHBORS
      ...
      !< -------------------------- real buffers
      !NLEN_SEND = MAX(OS%NIC_S, OS%NIC_R)*TYPE_LAYER*SL%NCPL_MAX*2+10
