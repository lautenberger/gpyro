...
! CWL: commented above and replaced with below
  interface mpi_recv
    module procedure mpi_recv_int0    , mpi_recv_int1,    mpi_recv_int2, &
                     mpi_recv_real0   , mpi_recv_real1,   mpi_recv_real2,&
                     mpi_recv_logical0, mpi_recv_logical1,&
                     mpi_recv_char0   , mpi_recv_char1   
  end interface mpi_recv
...
! CWL: commented above and replaced with below
  interface mpi_send
    module procedure mpi_send_int0    , mpi_send_int1,     mpi_send_int2,  &
                     mpi_send_real0   , mpi_send_real1,    mpi_send_real2, &
                     mpi_send_logical0, mpi_send_logical1, &
                     mpi_send_char0   , mpi_send_char1
  end interface mpi_send
...
!  end interface mpi_bcast
  interface mpi_bcast
    module procedure mpi_bcast_int0   , mpi_bcast_int1,      mpi_bcast_int2, &
                     mpi_bcast_real0   , mpi_bcast_real1,    mpi_bcast_real2,&
                     mpi_bcast_logical0, mpi_bcast_logical1
  end interface mpi_bcast
...
! CWL: added following subroutine:
subroutine mpi_recv_int2 ( data, n, datatype, iproc, itag, comm, istatus, ierror )
  implicit none
  integer:: n
  integer:: comm
  integer, dimension(:,:) :: data
  ...
  integer, dimension(:) :: istatus
  integer:: itag
  dummy = data(1,1) + n + datatype + iproc + itag + comm + istatus(1) + ierror
end subroutine
...
!CWL: Added this subroutine:
subroutine mpi_recv_real2 ( data, n, datatype, iproc, itag, comm, istatus, ierror )
  implicit none
  integer:: n
  integer:: comm
  real(eb), dimension(:,:) :: data
...
!CWL: Added this subroutine:
subroutine mpi_send_int2( data, n, datatype, iproc, itag, comm, ierror )
  implicit none
  integer:: n
  integer:: comm
  integer, dimension(:,:):: data
  ...
  integer:: iproc
  integer:: itag
  dummy = data(1,1) + n + datatype + iproc + itag + comm + ierror
end subroutine
...
!CWL: added this subroutine 
subroutine mpi_send_real2( data, n, datatype, iproc, itag, comm, ierror )
  implicit none
  integer:: n
  integer:: comm
  real(eb), dimension(:,:):: data
...
!CWL: Added this subroutine:
subroutine mpi_bcast_int2 ( data, n, datatype, node, comm, ierror )
  integer:: n
  integer:: comm
  integer, dimension(:,:):: data
  integer:: datatype
  integer:: ierror
  integer:: node
  dummy = data(1,1) + n + datatype + node + comm + ierror
end subroutine
...
!CWL: Added this subroutine:
subroutine mpi_bcast_real2 ( data, n, datatype, node, comm, ierror )
  integer:: n
  integer:: comm
  real(eb), dimension(:,:):: data
  integer:: datatype
