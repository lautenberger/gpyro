...
CHARACTER(255), PARAMETER :: ctrlid='$Id: ctrl.f90 21105 2014-12-05 16:07:48Z mcgratta $'
CHARACTER(255), PARAMETER :: ctrlrev='$Revision: 21105 $'
CHARACTER(255), PARAMETER :: ctrldate='$Date: 2014-12-05 08:07:48 -0800 (Fri, 05 Dec 2014) $'
...
USE GLOBAL_CONSTANTS, ONLY: CORE_CLOCK
REAL(EB), INTENT(IN) :: T(NMESHES),DT
