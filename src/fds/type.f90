...
IMPLICIT NONE
CHARACTER(255), PARAMETER :: typeid='$Id: type.f90 22204 2015-04-02 19:41:33Z randy.mcdermott $'
CHARACTER(255), PARAMETER :: typerev='$Revision: 22204 $'
CHARACTER(255), PARAMETER :: typedate='$Date: 2015-04-02 12:41:33 -0700 (Thu, 02 Apr 2015) $'
...
INTEGER, PARAMETER :: N_PARTICLE_SCALAR_REALS=13,N_PARTICLE_SCALAR_INTEGERS=6,N_PARTICLE_SCALAR_LOGICALS=2

TYPE LAGRANGIAN_PARTICLE_TYPE
   TYPE (ONE_D_M_AND_E_XFER_TYPE) :: ONE_D
   LOGICAL, POINTER :: SHOW,SPLAT
   REAL(EB), POINTER :: X,Y,Z,U,V,W,PWT,ACCEL_X,ACCEL_Y,ACCEL_Z,RE,MASS,T_INSERT
...
INTEGER, PARAMETER :: N_WALL_SCALAR_REALS=19,N_WALL_SCALAR_INTEGERS=14,N_WALL_SCALAR_LOGICALS=0
...
TYPE WALL_TYPE
   ...
   INTEGER, POINTER :: WALL_INDEX,SURF_INDEX,BACK_INDEX,BACK_MESH,BOUNDARY_TYPE,SURF_INDEX_ORIG,OBST_INDEX, &
                       PRESSURE_BC_INDEX,PRESSURE_ZONE,VENT_INDEX,NODE_INDEX,NOM,NIC_MIN,NIC_MAX
END TYPE WALL_TYPE
...
TYPE SPECIES_TYPE
   ...
   LOGICAL ::  ISFUEL=.FALSE.,LISTED=.FALSE.,AGGLOMERATING=.FALSE.
...
TYPE SPECIES_MIXTURE_TYPE
   ...
   REAL(EB) :: MW , RCON, ZZ0=0._EB, MASS_EXTINCTION_COEFFICIENT=0._EB,ADJUST_NU=1._EB,ATOMS(118)=0._EB,MEAN_DIAMETER,&
               ...
               DENSITY_SOLID,CONDUCTIVITY_SOLID,H_F
...
TYPE REACTION_TYPE
   CHARACTER(LABEL_LENGTH) :: FUEL,OXIDIZER,PRODUCTS,ID
   ...
   INTEGER :: FUEL_SMIX_INDEX=-1,AIR_SMIX_INDEX=-1,MODE,N_SMIX,N_SPEC
...
TYPE SURFACE_TYPE
   ...
   CHARACTER(100) :: FYI='null'
   LOGICAL :: GPYRO=.FALSE. !CWL: Added this line
...
TYPE OMESH_TYPE
   ...
   INTEGER, ALLOCATABLE, DIMENSION(:,:) :: IJKW
...
TYPE VENTS_TYPE
   ...
   REAL(EB) :: X1=0._EB,X2=0._EB,Y1=0._EB,Y2=0._EB,Z1=0._EB,Z2=0._EB,FDS_AREA=0._EB, &
               ...
               DYNAMIC_PRESSURE=0._EB,UVW(3)=-1.E12_EB,RADIUS=-1._EB
...
TYPE SLICE_TYPE
   INTEGER :: I1,I2,J1,J2,K1,K2,INDEX,INDEX2=0,Z_INDEX=-999,Y_INDEX=-999,PART_INDEX=0,VELO_INDEX=0,PROP_INDEX=0
