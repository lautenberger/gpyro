...
CHARACTER(255), PARAMETER :: meshid='$Id: mesh.f90 22069 2015-03-21 16:43:20Z randy.mcdermott $'
CHARACTER(255), PARAMETER :: meshrev='$Revision: 22069 $'
CHARACTER(255), PARAMETER :: meshdate='$Date: 2015-03-21 09:43:20 -0700 (Sat, 21 Mar 2015) $'
 
TYPE MESH_TYPE

   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: &
            U,V,W,US,VS,WS,DDDT,D,DS,H,HS,KRES,FVX,FVY,FVZ,RHO,RHOS, &
            MU,MU_DNS,TMP,Q,FRHO,KAPPA,QR,QR_W,UII,RSUM,D_LAGRANGIAN,D_REACTION,D_GEOMETRY, &
            CSD2,CHEM_SUBIT,MIX_TIME,STRAIN_RATE,D_Z_MAX
   ...
   REAL(EB) :: CFL,DIVMX,DIVMN,VN,RESMAX,PART_UVWMAX
   ...
   INTEGER :: N_WALL_CELLS,N_WALL_CELLS_DIM,N_INTERNAL_WALL_CELLS,N_EXTERNAL_WALL_CELLS,WALL_COUNTER,N_GPYRO_WALL_CELLS !CWL: added N_GPYRO_WALL_CELLS
   REAL(EB) :: BC_CLOCK
...
REAL(EB), POINTER, DIMENSION(:,:,:) :: &
   U,V,W,US,VS,WS,DDDT,D,DS,H,HS,KRES,FVX,FVY,FVZ,RHO,RHOS, &
   MU,MU_DNS,TMP,Q,FRHO,KAPPA,QR,QR_W,UII,RSUM,D_LAGRANGIAN,D_REACTION,D_GEOMETRY, &
   CSD2,MTR,MSR,WEM,MIX_TIME,CHEM_SUBIT,STRAIN_RATE,D_Z_MAX
...
INTEGER, POINTER :: N_WALL_CELLS,N_WALL_CELLS_DIM,N_INTERNAL_WALL_CELLS,N_EXTERNAL_WALL_CELLS,WALL_COUNTER,N_GPYRO_WALL_CELLS !CWL: added N_GPYRO_WALL_CELLS
...
WRITE(MODULE_DATE,'(A)') meshrev(INDEX(meshrev,':')+2:LEN_TRIM(meshrev)-2)
