...
CHARACTER(255), PARAMETER :: devcid='$Id: devc.f90 21787 2015-02-18 20:45:56Z drjfloyd@gmail.com $'
CHARACTER(255), PARAMETER :: devcrev='$Revision: 21787 $'
CHARACTER(255), PARAMETER :: devcdate='$Date: 2015-02-18 12:45:56 -0800 (Wed, 18 Feb 2015) $'
...
TYPE PROPERTY_TYPE
   REAL(EB) :: BEAD_DENSITY,BEAD_DIAMETER,BEAD_EMISSIVITY,BEAD_H_FIXED,BEAD_SPECIFIC_HEAT,RTI, &
               ...
               GAUGE_TEMPERATURE,INITIAL_TEMPERATURE,K_FACTOR,C_FACTOR,OPERATING_PRESSURE,OFFSET,SPRAY_ANGLE(2,2), &
...
TYPE DEVICE_TYPE
   ...
   REAL(EB), ALLOCATABLE, DIMENSION(:,:) :: YY_SOOT, ILW
   INTEGER  :: OUTPUT_INDEX,OUTPUT2_INDEX,IOR,IOR_ASSUMED=0,WALL_INDEX,ORDINAL,I,J,K,MESH,I1=-1,I2=-1,J1=-1,J2=-1,K1=-1,K2=-1,&
               I_DEPTH,N_PATH,N_T_E,PROP_INDEX,ORIENTATION_INDEX=0,STATISTICS_LOCATION_INDEX=0,&
               TRIP_DIRECTION,CTRL_INDEX=-1,N_INPUTS,SURF_INDEX=-1,Z_INDEX=-999,Y_INDEX=-999,PART_INDEX=0,&
   ...
   CHARACTER(LABEL_LENGTH) :: ID,PROP_ID,QUANTITY,QUANTITY2,CTRL_ID,DEVC_ID,STATISTICS='null',&
                    ...
                    INIT_ID='null',NO_UPDATE_DEVC_ID='null',NO_UPDATE_CTRL_ID='null'
...
INTEGER :: N_PROP,N_DEVC,N_DEVC_TIME,N_DEVC_LINE,MAX_DEVC_LINE_POINTS,N_PDPA_HISTOGRAM = 0,MAX_PDPA_HISTOGRAM_NBINS = 0
...
TYPE CONTROL_TYPE
   ...
   REAL(EB) :: SETPOINT(2)=1000000._EB, DELAY=0._EB, T_CHANGE=1000000._EB ,CYCLE_TIME=1000000._EB,CONSTANT=-9.E30_EB,& 
