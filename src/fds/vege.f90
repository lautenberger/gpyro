...
IMPLICIT NONE
PRIVATE
PUBLIC INITIALIZE_LEVEL_SET_FIRESPREAD,LEVEL_SET_FIRESPREAD, GET_REV_vege, BNDRY_VEG_MASS_ENERGY_TRANSFER
TYPE (LAGRANGIAN_PARTICLE_TYPE), POINTER :: LP=>NULL()
TYPE (LAGRANGIAN_PARTICLE_CLASS_TYPE), POINTER :: LPC=>NULL()
!TYPE (WALL_TYPE), POINTER :: WC
!TYPE (SURFACE_TYPE), POINTER :: SF 
CHARACTER(255), PARAMETER :: vegeid='$Id: vege.f90 21496 2015-01-22 00:38:36Z gforney $'
CHARACTER(255), PARAMETER :: vegerev='$Revision: 21496 $'
CHARACTER(255), PARAMETER :: vegedate='$Date: 2015-01-21 16:38:36 -0800 (Wed, 21 Jan 2015) $'
...
! Initialize quantities
  ...
  WC%ONE_D%MASSFLUX_ACTUAL(I_FUEL) = 0.0_EB
  WC%ONE_D%QCONF           = 0.0_EB
  IF (I_WATER > 0) THEN
   WC%ONE_D%MASSFLUX(I_WATER) = 0.0_EB
   WC%ONE_D%MASSFLUX_ACTUAL(I_WATER) = 0.0_EB
  ENDIF
