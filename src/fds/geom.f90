...
CHARACTER(255), PARAMETER :: geomid='$Id: geom.f90 21870 2015-03-06 22:26:56Z gforney $'
CHARACTER(255), PARAMETER :: geomrev='$Revision: 21870 $'
CHARACTER(255), PARAMETER :: geomdate='$Date: 2015-03-06 14:26:56 -0800 (Fri, 06 Mar 2015) $'
...
! 1-------2
   ...
   IF(.NOT.AUTO_TEXTURE.AND.N_VERTS.GT.0)THEN
      TXMIN = VERTS(1)
      TXMAX = TXMIN
      TYMIN = VERTS(2)
      TYMAX = TYMIN
      DO I = 1, N_VERTS
         TX = VERTS(3*I-2)
         TY = VERTS(3*I-1)
         IF(TX.LT.TXMIN)TXMIN=TX
         IF(TX.GT.TXMAX)TXMAX=TX
         IF(TY.LT.TYMIN)TYMIN=TY
         IF(TY.GT.TYMAX)TYMAX=TY
      END DO
