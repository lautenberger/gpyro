...
CHARACTER(255), PARAMETER :: poisid='$Id: pois.f90 21858 2015-03-05 19:11:10Z mcgratta $'
CHARACTER(255), PARAMETER :: poisrev='$Revision: 21858 $'
CHARACTER(255), PARAMETER :: poisdate='$Date: 2015-03-05 11:11:10 -0800 (Thu, 05 Mar 2015) $'
...
SUBROUTINE GET_REV_pois(MODULE_REV,MODULE_DATE)
INTEGER,INTENT(INOUT) :: MODULE_REV
CHARACTER(255),INTENT(INOUT) :: MODULE_DATE

WRITE(MODULE_DATE,'(A)') poisrev(INDEX(poisrev,':')+2:LEN_TRIM(poisrev)-2)
READ (MODULE_DATE,'(I5)') MODULE_REV
WRITE(MODULE_DATE,'(A)') poisdate

END SUBROUTINE GET_REV_pois
