...
CHARACTER(255), PARAMETER :: fireid='$Id: fire.f90 21953 2015-03-12 12:30:45Z randy.mcdermott $'
CHARACTER(255), PARAMETER :: firerev='$Revision: 21953 $'
CHARACTER(255), PARAMETER :: firedate='$Date: 2015-03-12 05:30:45 -0700 (Thu, 12 Mar 2015) $'
...
REAL(EB) :: ERR_EST,ERR_TOL,ZZ_TEMP(1:N_TRACKED_SPECIES),&
            ...
            ZZ_MIXED_NEW(1:N_TRACKED_SPECIES),TAU_D,TAU_G,TAU_U,TAU_MIX,DELTA,TMP_MIXED,DT_SUB_MIN,RHO_HAT
...
REAL(EB), INTENT(IN) :: ZZ_IN(1:N_TRACKED_SPECIES),ZETA_IN,DT_LOC,RHO_HAT,ZZ_UNMIXED(1:N_TRACKED_SPECIES),CELL_MASS,&
                        TAU_MIX
...
IF (.NOT.ALL(REACTION(:)%FAST_CHEMISTRY)) THEN
   ...
   IF (TEMPERATURE_DEPENDENT_REACTION) THEN
      Q_TEMP = SUM(SPECIES_MIXTURE%H_F*DZZ*BOUNDEDNESS_CORRECTION)
...
REAL(EB), INTENT(IN) :: ZZ_0(1:N_TRACKED_SPECIES),DT_LOC,RHO_0,TMP_0
