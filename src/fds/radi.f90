...
CHARACTER(255), PARAMETER :: radiid='$Id: radi.f90 22009 2015-03-17 12:38:07Z mcgratta $'
CHARACTER(255), PARAMETER :: radirev='$Revision: 22009 $'
CHARACTER(255), PARAMETER :: radidate='$Date: 2015-03-17 05:38:07 -0700 (Tue, 17 Mar 2015) $'
...
REAL(EB) :: T, RAP, AX, AXU, AXD, AY, AYU, AYD, AZ, VC, RU, RD, RP, &
            ...
            AIU_SUM,A_SUM,KFST4_SUM,RAD_Q_SUM,RTE_SOURCE_CORRECTION_FACTOR,VOL, VC1,AY1,AZ1,COSINE
