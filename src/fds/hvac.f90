...
CHARACTER(255), PARAMETER :: hvacid='$Id: hvac.f90 22106 2015-03-24 12:54:06Z drjfloyd@gmail.com $'
CHARACTER(255), PARAMETER :: hvacrev='$Revision: 22106 $'
CHARACTER(255), PARAMETER :: hvacdate='$Date: 2015-03-24 05:54:06 -0700 (Tue, 24 Mar 2015) $'
...
ITER_LOOP: DO
   ...
   DUCT_LOOP:DO ND = 1,NE%N_DUCTS
      ...
      IF (DN%UPDATED) THEN
         ...
         DU%ZZ(:) = DN%ZZ(:)
         ZZ_GET = DU%ZZ
         CALL GET_AVERAGE_SPECIFIC_HEAT(ZZ_GET,CP,DU%TMP_D)
      ENDIF
   ENDDO DUCT_LOOP
