...
CHARACTER(255), PARAMETER :: precid='$Id: prec.f90 21397 2015-01-15 14:38:00Z mcgratta $'
CHARACTER(255), PARAMETER :: precrev='$Revision: 21397 $'
CHARACTER(255), PARAMETER :: precdate='$Date: 2015-01-15 06:38:00 -0800 (Thu, 15 Jan 2015) $'
