...
CHARACTER(255), PARAMETER :: consid='$Id: cons.f90 22307 2015-04-09 20:12:34Z mcgratta $'
CHARACTER(255), PARAMETER :: consrev='$Revision: 22307 $'
CHARACTER(255), PARAMETER :: consdate='$Date: 2015-04-09 13:12:34 -0700 (Thu, 09 Apr 2015) $'
...
INTEGER, PARAMETER :: CONVECTIVE_FLUX_BC=-1,NET_FLUX_BC=0,SPECIFIED_TEMPERATURE=1,&
                      ...
                      INTERPOLATED_BC=6,&
                      VEG_BNDRY_FUEL=99,GPYRO_BC=8                                          ! Heat transfer BC, CWL: added GPYRO_BC
...
LOGICAL :: LES,DNS,RADIATION=.TRUE.,RADIATION_COMPLETED=.TRUE.,EXCHANGE_RADIATION=.FALSE.,KAPPA_ARRAY=.FALSE.,CYLINDRICAL,NOISE, &
           ...
           CHECK_REALIZABILITY=.FALSE.,USE_NEW_CHECK_MASS_FRACTION=.FALSE.,NEW_OPEN_BOUNDARY=.FALSE.
...
REAL(EB) :: TIGNSTART=0D0, TIGNSTOP=0D0, IGNPOW=0D0, IGNLOC(1:6)=0D0,TSTART_SKIP_FDS_TIMESEPS = 9D9 !CWL
LOGICAL :: SKIP_FDS_TIMESTEPS = .FALSE. !, CALL_PYROLYSIS=.FALSE. !CWL
INTEGER :: NSKIP_FDS_TIMESTEPS = 1 !CWL
