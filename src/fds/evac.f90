...
MODULE EVAC
  ...
  IMPLICIT NONE
  !
  CHARACTER(255), PARAMETER :: evacid='$Id: evac.f90 21709 2015-02-11 10:14:22Z tkorhon1@gmail.com $'
  CHARACTER(255), PARAMETER :: evacrev='$Revision: 21709 $'
  CHARACTER(255), PARAMETER :: evacdate='$Date: 2015-02-11 02:14:22 -0800 (Wed, 11 Feb 2015) $'
  !
  PRIVATE
